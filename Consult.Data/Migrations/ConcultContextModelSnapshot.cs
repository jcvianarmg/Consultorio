...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Consult.Core.Domain.Funcao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Consult.Core.Domain.Usuario", b =>
                {
            ...
            modelBuilder.Entity("FuncaoUsuario", b =>
                {
                    b.HasOne("Consult.Core.Domain.Funcao", null)
                        .WithMany()
                        .HasForeignKey("FuncoesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Consult.Core.Domain.Usuario", null)
                        .WithMany()
